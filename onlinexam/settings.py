...
MIDDLEWARE = [
    ...
    # 'onlinexam.middleware.Custom404Middleware',
...
AUTH_USER_MODEL = 'exam.User'  # Make sure 'exam' is in INSTALLED_APPS and migrations are applied


JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "CONMJ Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Nursing",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "College of Nursing",
    ...
    "welcome_sign": "Welcome to the School of Nursing",

    # Copyright on the footer
    "copyright": "dreamer Ltd",
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://gradenet.ng", "new_window": True},
    ...
    "usermenu_links": [
        {"name": "Support", "url": "https://hensonport.vercel.app", "new_window": True},
        {"model": "auth.user"}
    ],
